...
function Templete({title,desc1,desc2,img,formType,setIsLoggedIn}){
    return(<div className='flex justify-between w-11/12 max-w-[1160px] pt-[11rem] py-12 mx-auto gap-x-12 gap-y-0'>
